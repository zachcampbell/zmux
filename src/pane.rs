...
impl Pane {
    ...
    // full rationale — without this sync, the first mouse-wheel notch
    // out of follow mode lands a whole grid's worth of lines above
    // where the user was actually looking.
